<template>
    <div class="user-repair">
        <table>
            <tr>
                <td>姓名：</td>
                <td><Input style="width: 300px" v-model="params.susername"></input></td>
            </tr>
            ...
            <tr>
                <td>紧急联系人：</td>
                <td><Input style="width: 300px" v-model="params.smobile"></input></td>
            </tr>
            <tr>
                <td>身份证：</td>
                <td>
            ...
            <tr>
                <td>地址：</td>
                <td><Input style="width: 300px" v-model="params.address"></input></td>
            </tr>
            <tr>
                <td>创建时间：</td>
                <td>
