<template>
    <div class="vehicle-manager">
        ...
        <div class="input-infor">
            ...
            <Input v-model="params.mode"   style="width: 200px" ref="inputValue"></input>
            <label for="">车主姓名</label>
            <Input v-model="params.ownerUserName"   style="width: 200px" ref="inputValue"></input>
            <br/><br/>
            <label for="">所属门店</label>
            <Input v-model="params.storeId"   style="width: 200px" ref="inputValue"></input>

            <label for="">车牌号码</label>
             <Input v-model="params.carNo"   style="width: 200px" ref="inputValue"></input>
            <Form>
                <FormItem label="状态">
...
//carBodyImage
//:
//"http://mimg.5566go.com/carinfo/2018-03-31/31LlkpEPQ7-1522429273289.jpg"
//carBodyImage1
//:
//"http://mimg.5566go.com/carinfo/2018-03-31/FhXmTM9I8K-1522429533955.jpg"
//carCabImage
//:
//"http://mimg.5566go.com/carinfo/2018-03-31/x9btZRIlmO-1522429477063.jpg"
//carEngine
//:
//"4"
//carHeaderImage
//:
//"http://mimg.5566go.com/carinfo/2018-03-31/Fa6C7U9kJk-1522429171802.jpg"
//carId
//:
//896
//carKm
...
//carSeatImage
//:
//"http://mimg.5566go.com/carinfo/2018-03-31/Wq2IwlioMZ-1522429428175.jpg"
//carSeetCount
//:
//"5"
//carTailImage
//:
//"http://mimg.5566go.com/carinfo/2018-03-31/setR5I5C2L-1522429412867.jpg"
//carType
//:
//"英朗"
//carVin
...
<style>
	.vehicle-manager .welcome{padding-left:20px; }
	.main .single-page-con .single-page{background:#fff}
    ...
    .addinfo{margin-left:150px;}
    .input-infor{padding-left:20px; padding-top:20px; }
