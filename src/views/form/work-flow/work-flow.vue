            ...
            <Card>
                ...
                <Form class="step-form" ref="step" :model="step" :rules="stepRules" :label-width="100">
                    <FormItem label="意见：" prop="opinion">
                        <Input :disabled="hasSubmit" v-model="step.opinion" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入意见" /></input>
                    </FormItem>
                    <FormItem label="备注：">
                        <Input :disabled="hasSubmit" v-model="step.remark" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入备注" /></input>
                    </FormItem>
